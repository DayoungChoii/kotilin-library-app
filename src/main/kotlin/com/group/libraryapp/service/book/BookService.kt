...
class BookService (
    ...
    fun returnBook(request: BookReturnRequest) {
        val book = userRepository.findByName(request.userName) ?: fail()
        book.returnBook(request.bookName)
    }
    ...
    fun getBookStatistics(): List<BookStatResponse> = bookRepository.getStatus()
}